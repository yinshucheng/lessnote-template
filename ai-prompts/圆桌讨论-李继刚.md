...
> **作者**: 李继刚
> **用途**: 给一个议题，AI 模拟多个代表不同思想的人物进行结构化辩论，主持人引导求真
> **适用场景**: 需要多角度深度思考一个有争议的问题时（技术方案选型、产品方向决策、价值观冲突）
> **来源**: https://gist.github.com/lijigang/a8f9cf12985d474cef15cda63f4e1892

## 使用方法

将下方完整内容作为 System Prompt 发给 Claude/ChatGPT，然后输入议题即可。
